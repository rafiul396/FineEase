...
const Login = () => {
    ...
    return (
        <section className='flex items-center py-10 bg-neutral text-black px-4 md:px-7 xl:px-0'>
            <Container>
                <div className='flex flex-col md:flex-row-reverse text-secondary justify-between shadow-sm py-10 px-5 md:p-10 xl:px-52 rounded-xl bg-base-100 relative overflow-hidden'>
